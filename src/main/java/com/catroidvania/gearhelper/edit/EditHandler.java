...
public class EditHandler {
    ...
    public boolean fill(PlayerSelection ps, int bid, int metadata) {
    ...
    public boolean pasteAtPos1(PlayerSelection ps) {
        return pasteAt(ps.getX1(), ps.getY1(), ps.getZ1());
    }

    public boolean pasteHere(PlayerSelection ps) {
    ...
    public boolean pasteAt(int x, int y, int z) {
        if (clipboard != null) {
            /*
